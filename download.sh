...
# Deprecated!
#
# Pillar installation script for pillar version <= 5
# This script downloads an image and VM containing pillar v5.0
# Do not use for latest versions. Check the project README file
