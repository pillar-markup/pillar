...
echo =====================================================
echo = Downloading Pharo and loading Pillar
echo =====================================================
...
${PHARO} --save "PharoFilesOpener default unsetInformAboutReadOnlyChanges."
${PHARO} --save "Smalltalk logFileName: '/tmp/pillar.log'"